...
const MyPosts = (props:PostPropsType) => {
        let NewMessagesData = props.messageData.map((item) => <Post message={item.message} countLikes={item.countLike}
                                                                    key={item.id}/>)
        return <>
                ...
                <div className={classes.news__feed}>
                    ...
                    <form>
                        <div className={classes.group}>
                            <textarea name="message" className={classes.form__control}
